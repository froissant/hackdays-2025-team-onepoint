...
def getParamsFromPrompt(prompt: str):
    response = client.chat.completions.create(
        ...
        messages=[
            ...
            "the id of the template must absolutely exist in the json array below that contains the id and name of many meme templates. It is your task to know which template the user is refering to, by comparing the description to the names and ids, and return the corresponding id."
